...
(defn initial-ui [app-state]
  [:div.initial-ui
   ...
   [:p "I built this little tool to answer all those questions. It takes a CSV file generated by "
    ...
    " collection export feature, and it shows you a bunch of progress bars."]
   ...
   [:p.demo "If you don't have one of this files and want to see what the tool looks like, "]
